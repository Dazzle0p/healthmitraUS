...
const ACTIONS = [
  {
    ...
    href: "/service-requests/new?type=medical_consultation",
    color: "text-teal-600",
    bg: "bg-teal-50",
    border: "hover:border-teal-300 hover:bg-teal-50",
  },
  {
    icon: FlaskConical,
    label: "Book Test",
    href: "/service-requests/new?type=diagnostic",
    color: "text-blue-600",
    bg: "bg-blue-50",
  ...
  // { icon: Pill, label: 'Order Medicine', href: '/service-requests/new?type=medicine', color: 'text-emerald-600', bg: 'bg-emerald-50', border: 'hover:border-emerald-300 hover:bg-emerald-50' },
  {
    icon: Ambulance,
    label: "Ambulance",
    href: "/service-requests/new?type=ambulance",
    color: "text-red-600",
    bg: "bg-red-50",
    border: "hover:border-red-300 hover:bg-red-50",
  },
  {
    icon: Receipt,
    label: "Reimbursement",
    ...
    bg: "bg-amber-50",
    border: "hover:border-amber-300 hover:bg-amber-50",
  },
  {
    icon: CreditCard,
    label: "View E-Card",
